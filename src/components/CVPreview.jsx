export function CVPreview({ cvData, layout, customization = {} }) {
  ...
  const Languages = cvData.languages?.length > 0 ? (
    <div className="cv-section">
      <h3>Languages</h3>
      <div className="skills-list">
  ...
  const Interests = cvData.interests?.length > 0 ? (
    <div className="cv-section">
      <h3>Interests</h3>
      <div className="skills-list">
  ...
  const Projects = cvData.projects?.length > 0 ? (
    <div className="cv-section">
      <h3>Projects</h3>
  ...
  const isTwoColumn = layout === 'twoColumn' || layoutClass === 'two-column'
